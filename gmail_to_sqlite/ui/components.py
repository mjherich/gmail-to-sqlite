...
class TableBuilder:
    ...
    def create(self, title: Optional[str] = None, caption: Optional[str] = None) -> 'TableBuilder':
        """Create a new table."""
        self.table = Table(
            title=title,
            caption=caption,
    ...
    def add_column(self, name: str, justify: str = "left", style: Optional[str] = None, no_wrap: bool = False) -> 'TableBuilder':
...
class ModelSelector:
    ...
    def show_models(self, models: Dict[str, Dict[str, str]]) -> str:
        ...
        while True:
            choice = self.console.input("[prompt]Select model (1-3) or press Enter for default: [/]").strip()
