...
class ChatDisplay:
    ...
    def show_initialization(
        self, model_description: str, session_id: Optional[str] = None
    ):
    ...
    def show_query_results(self, results: str, row_count: Optional[int] = None):
        ...
        if "|" in results and "-" in results:
            ...
            panel = Panel(results, title=title, border_style="info", padding=(1, 2))
    ...
    def show_goodbye(self):
        ...
        goodbye_text = Text(
            "👋 Goodbye! Thanks for chatting about your Gmail data.", style="success"
        )
        self.console.print()
